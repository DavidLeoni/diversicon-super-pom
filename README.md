...
|-----------|---------|-----------|----------------|
| See [TOD Super Pom](https://github.com/opendatatrentino/tod-super-pom) |Business-friendly [Apache License v2.0](LICENSE.txt) | See [project milestones](../../milestones) | See [wiki](../../wiki)|
